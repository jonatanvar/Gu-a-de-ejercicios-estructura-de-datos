...
//Fecha: 19/07/2024
//Descripción: Programa que encuentra todos los libros de un autor dado.
...
int main() {
    cout << "Bienvenido al Ejercicio 56 - Buscar Libro por Autor\n"; // Mensaje de bienvenida personalizado.
    char continuar; // Variable para controlar el bucle do...while.

    do {
        resolverEjercicio56(); // Llama a la función que contiene la lógica principal del ejercicio.
