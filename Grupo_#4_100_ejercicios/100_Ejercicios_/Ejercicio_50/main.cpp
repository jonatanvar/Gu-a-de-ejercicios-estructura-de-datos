...
//Fecha: 19/07/2024
//Descripción: Programa que identifica al estudiante con el mejor promedio.
...
int main() {
    cout << "Bienvenido al Ejercicio 50 - Estudiante con Promedio Mas Alto\n"; // Mensaje de bienvenida personalizado.
    char continuar; // Variable para controlar el bucle do...while.

    do {
        resolverEjercicio50(); // Llama a la función que contiene la lógica principal del ejercicio.
