...
//Fecha: 19/07/2024
//Descripción: Programa principal para demostrar la función push en una pila.
...
#include "funciones.h" // Se incluye el archivo de cabecera que contiene las declaraciones de funciones y la estructura Pila.
using namespace std;

int main() {
    cout << "Bienvenido al Ejercicio 62 - Funcion Push para Pila\n"; // Mensaje de bienvenida personalizado.
    char continuar; // Variable para controlar el bucle do...while.

    do {
        resolverEjercicio62(); // Llama a la función que contiene la lógica principal del ejercicio.
